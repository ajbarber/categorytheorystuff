...
The statement of the universal property is as follows. For any $f\colon F \rightarrow G$ such that $\theta \circ f = \epsilon \circ f$, there is a unique $\overline{f}\colon F \rightarrow ker(\theta)$ such that the diagram above commutes. That is $f = \iota \circ \overline{f}$. \\
