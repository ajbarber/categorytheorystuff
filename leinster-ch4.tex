...
\begin{equation*}
\begin{tikzcd}
  & \mathcal{O}(X) \arrow[d,"\alpha_X"] \arrow[r, "g"] & \mathcal{O}(Y) \arrow[d,"\alpha_Y"] \\
...
To prove $\mathcal{O} \cong H_S$, we need to show the isomorphism is natural, specifically the square above commutes.
\end {document}
